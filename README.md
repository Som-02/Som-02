...
|--------|-------------|------|
| [🧠 Sync Brain](https://github.com/Som-02/langchain-agent-chat-ui) | Personal AI assistant with +5 MCP tools, FastAPI backend, and Streamlit UI deployed on AWS EC2 | Python, LangChain, LangGraph, FastAPI, Streamlit, AWS EC2 |
...
⭐ If you like my work, consider giving some repos a star — it means a lot!
